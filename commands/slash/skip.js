	...
	.setRun(async (client, interaction, options) => {
		...
		if (!player) {
			return interaction.reply({
				embeds: [
					new MessageEmbed()
						.setColor("RED")
						.setDescription("Làm gì có bài hát nào được phát để bỏ qua -_-"),
				],
				ephemeral: true,
			});
		} 
		...
		return interaction.reply({
			embeds: [
				new MessageEmbed()
					.setColor("RED")
					.setDescription(`Không có bài hát nào tiếp theo để bỏ qua. Có mỗi [${ song.title }](${ song.uri }) trong Hàng chờ.`),
			],
		})}
